...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Flocoin
else
  DOCKER_EXEC echo \> \$HOME/.flocoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/flocoin/flocoin/pull/18288#discussion_r433189350 for
  # details.
