...
#ifndef FLOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define FLOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@flocoin.
 *
 ...
 *
 * The chacha20-poly1305@flocoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@flocoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@flocoin are relatively fast in
...
#endif // FLOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
