...
#ifndef FLOCOIN_SCRIPT_STANDARD_H
#define FLOCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a flocoin address
 */
...
/**
 * Generate a Flocoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FLOCOIN_SCRIPT_STANDARD_H
