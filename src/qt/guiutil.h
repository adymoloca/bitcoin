...
#ifndef FLOCOIN_QT_GUIUTIL_H
#define FLOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Flocoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "flocoin:" URI into recipient object, return true on successful parsing
