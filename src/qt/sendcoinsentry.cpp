    ...
    platformStyle(_platformStyle)
{
    ...
    // normal flocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying flocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &FlocoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
