    ...
    mapper(nullptr)
{
    ...
    ui->flocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->flocoinAtStartup);
    ...
    ui->flocoinAtStartup->setToolTip(ui->flocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->flocoinAtStartup->setText(ui->flocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openFlocoinConfButton->setToolTip(ui->openFlocoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new FlocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->flocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFlocoinConfButton_clicked()
{
