...
#ifndef FLOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define FLOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // FLOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
