...
#ifndef FLOCOIN_WALLET_ISMINE_H
#define FLOCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/flocoin/flocoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
