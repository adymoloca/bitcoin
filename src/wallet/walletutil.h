...
#ifndef FLOCOIN_WALLET_WALLETUTIL_H
#define FLOCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! flocoin from opening the wallet, thinking it was newly created, and
...
#endif // FLOCOIN_WALLET_WALLETUTIL_H
