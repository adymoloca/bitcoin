...
#ifndef FLOCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define FLOCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Flocoin Core wallet was originally a collection of unrelated private
...
#endif // FLOCOIN_WALLET_SCRIPTPUBKEYMAN_H
