...
#ifndef FLOCOIN_MINER_H
#define FLOCOIN_MINER_H
...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewBlock(const CScript& scriptPubKeyIn, std::string coinbaseFloData="");
