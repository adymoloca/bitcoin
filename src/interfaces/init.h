...
#ifndef FLOCOIN_INTERFACES_INIT_H
#define FLOCOIN_INTERFACES_INIT_H
...
//! (flocoin-gui, flocoin-node, flocoin-wallet, flocoind, flocoin-qt) and each
...
#endif // FLOCOIN_INTERFACES_INIT_H
