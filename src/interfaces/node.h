...
#ifndef FLOCOIN_INTERFACES_NODE_H
#define FLOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a flocoin node (flocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // FLOCOIN_INTERFACES_NODE_H
