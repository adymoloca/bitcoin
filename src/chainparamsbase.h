...
#ifndef FLOCOIN_CHAINPARAMSBASE_H
#define FLOCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between flocoin-cli and flocoind)
 * of a given instance of the Flocoin system.
 */
...
#endif // FLOCOIN_CHAINPARAMSBASE_H
