...
#ifndef FLOCOIN_TEST_SCRIPTNUM10_H
#define FLOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Flocoin Core 0.10.0, for cross-comparison.
 */
public:
