...
#ifndef FLOCOIN_TEST_UTIL_MINING_H
#define FLOCOIN_TEST_UTIL_MINING_H
...
std::vector<std::shared_ptr<CBlock>> CreateBlockChain(size_t total_height, const CChainParams& params, std::string strFloData);
...
#endif // FLOCOIN_TEST_UTIL_MINING_H
