...
#ifndef FLOCOIN_NET_H
#define FLOCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/flocoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Flocoin’s Peer-to-Peer Network")
