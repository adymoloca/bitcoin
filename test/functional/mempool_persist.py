...
By default, flocoind will dump mempool on shutdown and
...
class MempoolPersistTest(FlocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent flocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
