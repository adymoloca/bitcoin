...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FlocoinTestFramework
    pass


class ExampleTest(FlocoinTestFramework):
    # Each functional test is a subclass of the FlocoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FlocoinTestFramework class so other tests can use it."""
