...
class TestShell:
    """Wrapper Class for FlocoinTestFramework.

    The TestShell class extends the FlocoinTestFramework
    ...
    class __TestShell(FlocoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by FlocoinTestFramework child class.
            self.num_nodes = 1
