...
class P2PPermissionsTests(FlocoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].flocoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].flocoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
