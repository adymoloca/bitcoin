...
class TxnMallTest(FlocoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 FLO:
        ...
        # First: use raw transaction API to send 1240 FLO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FLO coin each
        ...
        # Node0's balance should be starting balance, plus 50FLO for another
        ...
        # Node0's total balance should be starting balance, plus 100FLO for
