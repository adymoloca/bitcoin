...
"""Verify that starting flocoin with -h works as expected."""

from test_framework.test_framework import FlocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FlocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start flocoin with -h for help text")
        ...
        self.log.info("Start flocoin with -version for version information")
        ...
        self.log.info("Start flocoind with -fakearg to make sure it does not start")
