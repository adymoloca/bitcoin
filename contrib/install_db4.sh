#!/bin/sh
# Copyright (c) 2017-2019 The Flocoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the flocoin repository."
  exit 1
fi
...
# See https://github.com/flocoin/flocoin/issues/16064
...
echo 'When compiling flocoind, run `./configure` in the following way:'
echo
