...
"""Script for verifying Flocoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
flocoincore.org and flocoin.org and compares them.
...
WORKINGDIR = "/tmp/flocoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://flocoincore.org"
HOST2 = "https://flocoin.org"
VERSIONPREFIX = "flocoin-core-"
...
def main(args):
    ...
    if not success:
        print("flocoin.org failed to provide signature file, "
              "but flocoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("flocoin.org and flocoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Flocoin Core binary release "
